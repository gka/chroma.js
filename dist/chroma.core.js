...
(function() {
  var CSSColors, Categories, Color, ColorScale, Diverging, Ramp, chroma, root, type, _ref, _ref1, _ref2, _ref3,
  ...
  Color.hcl2lab = function(h, c, l) {
    ...
    */
    ...
    if (type(h) === "array" && h.length === 3) {
      _ref1 = h, h = _ref1[0], c = _ref1[1], l = _ref1[2];
    }
    h /= 360.0;
    ...
    visit = function(val, k) {
      if (filter(val, k)) {
        if ((key != null) && type(key) === 'function') {
          return add(key(val));
        } else if ((key != null) && type(key) === 'str' || type(key) === 'number') {
          return add(val[key]);
        } else {
          return add(val);
        }
  ...
  chroma.limits = function(data, mode, num) {
    var assignments, best, centroids, cluster, clusterSizes, dist, i, j, kClusters, limits, max, min, mindist, n, nb_iters, newCentroids, p, pb, pr, repeat, sum, tmpKMeansBreaks, value, values, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _ref1, _ref10, _ref11, _ref12, _ref13, _ref14, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9, _s, _t, _u, _v;
    if (mode == null) {
      mode = 'equal';
    }
    if (num == null) {
    ...
    if (mode.substr(0, 1) === 'e') {
      ...
      */
      ...
      centroids.push(max);
      while (repeat) {
        for (j = _l = 0, _ref4 = num - 1; 0 <= _ref4 ? _l <= _ref4 : _l >= _ref4; j = 0 <= _ref4 ? ++_l : --_l) {
          clusterSizes[j] = 0;
        }
        for (i = _m = 0, _ref5 = n - 1; 0 <= _ref5 ? _m <= _ref5 : _m >= _ref5; i = 0 <= _ref5 ? ++_m : --_m) {
          value = values[i];
          mindist = Number.MAX_VALUE;
          for (j = _n = 0, _ref6 = num - 1; 0 <= _ref6 ? _n <= _ref6 : _n >= _ref6; j = 0 <= _ref6 ? ++_n : --_n) {
        ...
        for (i = _p = 0, _ref8 = n - 1; 0 <= _ref8 ? _p <= _ref8 : _p >= _ref8; i = 0 <= _ref8 ? ++_p : --_p) {
        ...
        for (j = _q = 0, _ref9 = num - 1; 0 <= _ref9 ? _q <= _ref9 : _q >= _ref9; j = 0 <= _ref9 ? ++_q : --_q) {
      ...
      for (i = _t = 0, _ref12 = n - 1; 0 <= _ref12 ? _t <= _ref12 : _t >= _ref12; i = 0 <= _ref12 ? ++_t : --_t) {
        cluster = assignments[i];
        kClusters[cluster].push(values[i]);
      }
      tmpKMeansBreaks = [];
      for (j = _u = 0, _ref13 = num - 1; 0 <= _ref13 ? _u <= _ref13 : _u >= _ref13; j = 0 <= _ref13 ? ++_u : --_u) {
      ...
      for (i = _v = 1, _ref14 = tmpKMeansBreaks.length - 1; _v <= _ref14; i = _v += 2) {
  ...
  */
  ...
  ColorScale = (function() {
    ...
    */
    ...
    function ColorScale(opts) {
      var c, col, cols, me, _i, _j, _ref2, _ref3, _ref4, _ref5, _ref6;
      me = this;
      me._colors = cols = (_ref2 = opts.colors) != null ? _ref2 : ['#ddd', '#222'];
      for (c = _i = 0, _ref3 = cols.length - 1; 0 <= _ref3 ? _i <= _ref3 : _i >= _ref3; c = 0 <= _ref3 ? ++_i : --_i) {
        col = cols[c];
        if (type(col) === "string") {
      ...
      if (opts.positions != null) {
        ...
        me._pos = [];
        for (c = _j = 0, _ref4 = cols.length - 1; 0 <= _ref4 ? _j <= _ref4 : _j >= _ref4; c = 0 <= _ref4 ? ++_j : --_j) {
  ...
  Ramp = (function(_super) {
    ...
    function Ramp(col0, col1, mode) {
      ...
      Ramp.__super__.constructor.call(this, {
        colors: [col0, col1],
        positions: [0, 1],
        mode: mode
      });
  ...
  chroma.ramp = function(col0, col1, mode) {
    var s;
  ...
  Diverging = (function(_super) {
    ...
    function Diverging(colors, center, mode) {
      var me;
      if (colors == null) {
        colors = ['#d73027', '#ffffbf', '#1E6189'];
      }
      if (center == null) {
        center = 0;
      }
      ...
      me = this;
      me._center = center;
      Diverging.__super__.constructor.call(this, {
        colors: colors,
        positions: [0, .5, 1],
        mode: mode
      });
    ...
    Diverging.prototype.domain = function(domain) {
      var me;
      if (domain == null) {
        domain = [];
      }
      me = this;
      Diverging.__super__.domain.call(this, domain);
  ...
  chroma.diverging = function(col0, col1, col2, center, mode) {
    var s;
