...
describe('Testing lightness correction', () => {
    ...
    describe('hot - with correction - domained [0,100]', () => {
        const f = chroma.scale(['white', 'yellow', 'red', 'black']).domain([0, 100]).mode('lab').correctLightness(true);
    ...
    describe('hot - w/o correction - domained [0,20,40,60,80,100]', () => {
        const f = chroma.scale(['white', 'yellow', 'red', 'black']).domain([0, 20, 40, 60, 80, 100]).mode('lab');
    ...
    describe('hot - with correction - domained [0,20,40,60,80,100]', () => {
        const f = chroma.scale(['white', 'yellow', 'red', 'black']).domain([0, 20, 40, 60, 80, 100]).mode('lab').correctLightness(true);
