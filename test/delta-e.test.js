    ...
    .addBatch({
        'retrieve delta-e value between two colors': {
            topic: {
                ...
                redgreen: {in: [0xff0000, 0x00ff00],     out: 80.33421120900258},
                greenred: {in: [0x00ff00, 0xff0000],     out: 57.55637002848759},
            ...
            num(topic) {
                Object.keys(topic).forEach(key => {
                    assert.deepEqual(deltaE(topic[key].in[0], topic[key].in[1]), topic[key].out);
                });
            }
        }
    })
