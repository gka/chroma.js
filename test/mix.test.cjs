...
vows.describe('Some tests for chroma.color()')
    ...
    .addBatch({
        'hsv interpolation white <-> red': {
            ...
            works(topic) {
                return assert.deepEqual(topic.hex(), '#ff8080');
            }
        },
        ...
        'alternative mix syntax': {
            ...
            works(topic) {
                return assert.deepEqual(topic.hex(), '#bf0040');
            }
        },
        ...
        'interpolation short function': {
            topic: {
                f(t) {
                    return chroma
                        .interpolate('#ff0000', '#ffffff', t, 'hsv')
                        .hex();
                }
            },
            'starts at red'(topic) {
                return assert.equal(topic.f(0), '#ff0000');
            },
            'goes over light red'(topic) {
                return assert.equal(topic.f(0.5), '#ff8080');
            },
            'ends at white'(topic) {
                return assert.equal(topic.f(1), '#ffffff');
            }
        },
        ...
        'num interpolation white <-> red': {
            ...
            works(topic) {
                return assert.deepEqual(topic.hex(), '#ff7fff');
            }
        },
        ...
        'interpolation short function with num provided': {
            topic: {
                f(t) {
                    return chroma
                        .interpolate(0xff0000, 0xffffff, t, 'num')
                        .hex();
                }
            },
            'starts at red'(topic) {
            ...
            'goes over light red'(topic) {
                return assert.equal(topic.f(0.5), '#ff7fff');
            },
            'ends at white'(topic) {
                return assert.equal(topic.f(1), '#ffffff');
            }
        ...
        'interpolate in num': {
            ...
            hex(topic) {
                return assert.equal(topic.hex(), '#8810b0');
            },
            num(topic) {
                return assert.equal(topic.num(), 8917168);
            }
        },
        ...
        'interpolate in hsv': {
            ...
            hex(topic) {
                return assert.equal(topic.hex(), '#808080');
            }
        },
        ...
        'interpolate in hsl': {
            ...
            hex(topic) {
                return assert.equal(topic.hex(), '#31ff98');
            }
        },
        ...
        'interpolate in lrgb': {
            ...
            hex(topic) {
                return assert.equal(topic.hex(), '#b400b4');
            }
        }
    })
    .export(module);
