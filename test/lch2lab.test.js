...
const testCases = [
    ...
    { name: 'yellow', lab: [97.14, -21.55, 94.48], lch: [97.14, 96.91, 102.85] },
    { name: 'green', lab: [87.73, -86.17, 83.18], lch: [87.73, 119.77, 136.01] },
    { name: 'cyan', lab: [91.11, -48.09, -14.13], lch: [91.11, 50.12, 196.37] },
    { name: 'blue', lab: [32.3, 79.2, -107.86], lch: [32.3, 133.81, 306.29] },
    { name: 'magenta', lab: [60.32, 98.23, -60.81], lch: [60.32, 115.53, 328.24] }
];
